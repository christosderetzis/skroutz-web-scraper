...
class PriceHistoryScraperSpec extends WithLoggingBaseSpec {
    ...
    def setup() {
        ...
        priceHistoryScraper = new PriceHistoryScraper(webClient,  150, 20, 3) // 150ms timeout for tests, 20ms retry delay, 3 max retries
    }
    ...
    def "fetchPriceHistory successfully fetches price history data"() {
        given: "a valid price history response"
            PriceHistoryResponseApiDto expectedResponse = PriceHistoryResponseApiDto.builder()
                    .minPrice(PriceHistoryResponseApiDto.MetricDataDto.builder()
                            .min(new BigDecimal("100.00"))
                            .max(new BigDecimal("200.00"))
                            .build())
                    .popularity(PriceHistoryResponseApiDto.MetricDataDto.builder()
                            .min(new BigDecimal("50"))
                            .max(new BigDecimal("150"))
                            .build())
                    .shopCount(PriceHistoryResponseApiDto.MetricDataDto.builder()
        ...
        when: "fetching price history"
            ...
            PriceHistoryResponseApiDto result = priceHistoryScraper.fetchPriceHistory(url)
    ...
    def "fetchPriceHistory handles slow response within timeout"() {
        given: "a valid response with delay"
            PriceHistoryResponseApiDto expectedResponse = PriceHistoryResponseApiDto.builder()
                    .minPrice(PriceHistoryResponseApiDto.MetricDataDto.builder().build())
                    .build()
        ...
        given: "a complex price history response with all nested data"
            PriceHistoryResponseApiDto expectedResponse = PriceHistoryResponseApiDto.builder()
                    .minPrice(PriceHistoryResponseApiDto.MetricDataDto.builder()
                            ...
                            .graphData(PriceHistoryResponseApiDto.GraphDataDto.builder()
                                    .oneMonth(PriceHistoryResponseApiDto.TimePeriodDto.builder()
                                            .hasValues(true)
                                            .label("1 month")
                                            .values(List.of(
                                                    PriceHistoryResponseApiDto.DataPointDto.builder()
